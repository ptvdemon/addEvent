...
var addeventatc = function() {
    var p, u, i, b, t, e = !1,
        ...
        T = !0,
        N = "Apple",
        A = "Google <em>(online)</em>",
        E = "Office 365 <em>(online)</em>",
        z = "Outlook",
        I = "Outlook.com <em>(online)</em>",
        C = "Yahoo <em>(online)</em>",
        $ = "Facebook Event",
        S = null,
        L = null,
        a = null,
    ...
    return {
        ...
        generate: function() {
            for (var d = document.getElementsByTagName("*"), c = 0; c < d.length; c += 1) addeventatc.hasclass(d[c], "addeventatc") && function() {
                var a = "addeventatc" + s;
                d[c].id = a, addeventatc.hasclass(d[c], "keeptitle") || (d[c].title = ""), d[c].style.visibility = "visible", d[c].setAttribute("aria-haspopup", "true"), d[c].setAttribute("aria-expanded", "false"), d[c].setAttribute("tabindex", "0"), d[c].setAttribute("translate", "no"), d[c].setAttribute("data-loaded", "true"), l ? (d[c].onclick = function() {
                    return !1
                ...
                var e = d[c];
                "none" != d[c].getAttribute("data-styling") && "inline-buttons" != d[c].getAttribute("data-render") || (r = !1), r && ((o = document.createElement("span")).className = "addeventatc_icon", e.appendChild(o)), s++, v = !0;
                for (var t = d[c].getElementsByTagName("*"), n = 0; n < t.length; n += 1) addeventatc.hasclass(t[n], "atc_node") || ("" != t[n].className ? t[n].className += " atc_node notranslate" : t[n].className += "atc_node");
        ...
        toogle: function(e, t) {
            ...
            if (c) {
                ...
                "ios" == addeventatc.agent() && "click" == t.type && "true" !== e && "false" !== i && (s = "appleical", c.setAttribute("data-intel-apple", "true"));
                try {
                ...
                if ("outlook" == s || "google" == s || "yahoo" == s || "hotmail" == s || "outlookcom" == s || "appleical" == s || "apple" == s || "facebook" == s) "click" == t.type && (addeventatc.click({
                    button: d,
                    service: s,
                    id: t.id
                    ...
                    for (var s, l = (f = (f += ",").replace(/ /gi, "")).split(","), r = 0; r < l.length; r += 1)(h && "ical" == l[r] || h && "appleical" == l[r]) && (n += '<span class="ateappleical" id="' + d + '-appleical" role="menuitem" tabindex="-1">' + N + "</span>"), x && "google" == l[r] && (n += '<span class="ategoogle" id="' + d + '-google" role="menuitem" tabindex="-1">' + A + "</span>"), w && "office365" == l[r] && (n += '<span class="ateoffice365" id="' + d + '-office365" role="menuitem" tabindex="-1">' + E + "</span>"), k && "outlook" == l[r] && (n += '<span class="ateoutlook" id="' + d + '-outlook" role="menuitem" tabindex="-1">' + z + "</span>"), (y && "hotmail" == l[r] || y && "outlookcom" == l[r]) && (n += '<span class="ateoutlookcom" id="' + d + '-outlookcom" role="menuitem" tabindex="-1">' + I + "</span>"), _ && "yahoo" == l[r] && !o && (n += '<span class="ateyahoo" id="' + d + '-yahoo" role="menuitem" tabindex="-1">' + C + "</span>"), a && "facebook" == l[r] && T && "facebook" == l[r] && (n += '<span class="atefacebook" id="' + d + '-facebook" role="menuitem" tabindex="-1">' + $ + "</span>");
                    addeventatc.getlicense(p) || (n += '<em class="copyx"><em class="brx"></em><em class="frs"><a href="https://www.addevent.com" title="" tabindex="-1" id="' + d + '-home"></a></em></em>'), $d(d + "-drop") || ((s = document.createElement("span")).id = d + "-drop", s.className = "addeventatc_dropdown", s.setAttribute("aria-hidden", "true"), s.setAttribute("aria-labelledby", d), s.innerHTML = n, c.appendChild(s)), $d(d + "-appleical") && ($d(d + "-appleical").onclick = function() {
                        addeventatc.click({
                            button: d,
                            service: "appleical",
                            id: t.id
        ...
        show: function(e, t) {
            var a, n, o, d, c, i, s, l, r, p, u, v, m, g, f = $d(e),
                h = $d(e + "-drop");
            f && h && ("block" == addeventatc.getstyle(h, "display") ? addeventatc.hideandreset() : (addeventatc.hideandreset(!0), h.style.display = "block", f.style.outline = "0", b = addeventatc.topzindex(), f.style.zIndex = b + 1, f.className = f.className.replace(/\s+/g, " "), f.setAttribute("aria-expanded", "true"), h.setAttribute("aria-hidden", "false"), t.keynav && addeventatc.keyboard(this, {
                type: "keyboard",
                id: e,
                key: "down"
                ...
                if (addeventatc.hasclass(a[n], "addeventatc")) {
                    ...
                    if (o) {
                        ...
                        for (var c = o.getElementsByTagName("SPAN"), i = 0; i < c.length; i += 1) {
                            ...
                            c[i].className = c[i].className.replace(s, " "), c[i].className = c[i].className.replace(/\s+$/, ""), c[i].tabIndex = "-1"
                        }
                    }
        ...
        topzindex: function() {
            for (var e, t = 1, a = document.getElementsByTagName("*"), n = 0; n < a.length; n += 1)(addeventatc.hasclass(a[n], "addeventatc") || addeventatc.hasclass(a[n], "addeventstc")) && (e = addeventatc.getstyle(a[n], "z-index"), !isNaN(parseFloat(e)) && isFinite(e) && t < (e = parseInt(e)) && (t = e));
            return t
        },
        viewport: function() {
            var e = 0,
        ...
        refresh: function() {
            ...
            addeventatc.removeelement($d("ate_css")), m = !(s = 1), addeventatc.generate()
        },
        ...
        documentclick: function(e) {
            ...
            e && (ate_touch_capable ? (clearTimeout(t), t = setTimeout(function() {
        ...
        keyboard: function(e, t) {
            ...
            if (a && "block" == addeventatc.getstyle(a, "display")) {
                ...
                for (var s, i = d = 0; i < n.length; i += 1) ++d == c ? (n[i].className += " drop_markup", n[i].tabIndex = "0", n[i].focus()) : (s = new RegExp("(\\s|^)drop_markup(\\s|$)"), n[i].className = n[i].className.replace(s, " "), n[i].className = n[i].className.replace(/\s+$/, ""), n[i].tabIndex = "-1")
            }
        },
        keyboardclick: function(e, t) {
            t = document.getElementById(t.id + "-drop");
            if (t) {
                for (var a = t.getElementsByTagName("SPAN"), n = null, o = 0; o < a.length; o += 1) addeventatc.hasclass(a[o], "drop_markup") && (n = a[o]);
                if (null !== n) {
                    n.click();
